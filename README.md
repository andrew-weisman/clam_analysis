...
Multiple-step process for preprocessing that I believe Pinyi basically ran, by example per the [CLAM GitHub page](https://github.com/mahmoodlab/CLAM):
...
## Directory structure assumed by the CLAM GitHub README
